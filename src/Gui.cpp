...

{
  ...
  AnmManager::ExecuteScripts(this->impl->vms0, 0x21);
  AnmManager::ExecuteScripts(this->impl->vms1, 5);
...

{
  ...
  if ((this->impl->msg.currentMsgIdx < 0) &&
    ...
    if ((local_94 < 10) && (this->lastSpellcardSecondsRemaining !=
      ...
      g_SoundPlayer.PlaySoundByIdx(SOUND_29);
    }
...

{
  ...
  if (bVar1) {
    memset(&g_Gui, 0, sizeof(Gui));
    g_Gui.impl = new GuiImpl;
  }
