...
struct ZunVec2 {
  ...
  __forceinline ZunVec2 operator*(f32 f) { return ZunVec2(x * f, y * f); }
};
...
struct ZunVec3 {
  ...
  __forceinline D3DXVECTOR3 *asD3DX() { return (D3DXVECTOR3 *)this; }
  ...
  __forceinline f32 Length() { return D3DXVec3Length(this->asD3DX()); }

  __forceinline ZunVec3 operator-() { return ZunVec3(-x, -y, -z); }
...
struct ZunQuaternion {
  ...
  D3DXQUATERNION *asD3DX() { return (D3DXQUATERNION *)this; }
};
...
struct ZunMatrix {
  ...
  D3DXMATRIX *asD3DX() { return (D3DXMATRIX *)this; }

  __forceinline void Identity() { D3DXMatrixIdentity((D3DXMATRIX *)this); }
