...
public:
    ...
    HRESULT OpenFromMemory(u8* pbData, ULONG ulDataSize, ThBgmFormat* pzwf, DWORD dwFlags);
    HRESULT Close();
...
public:
    ...
    HRESULT Initialize(HWND hWnd, DWORD dwCoopLevel, WORD dwPrimaryChannels, DWORD dwPrimaryFreq, u16 dwPrimaryBitRate);
    inline  LPDIRECTSOUND8 GetDirectSound() { return pDS; }
    HRESULT SetPrimaryBufferFormat(WORD dwPrimaryChannels, DWORD dwPrimaryFreq, u16 dwPrimaryBitRate);

    HRESULT CreateStreaming(CStreamingSound** ppStreamingSound, LPCSTR strWaveFileName, DWORD dwCreationFlags, GUID guid3DAlgorithm, DWORD dwNotifyCount, DWORD dwNotifySize, HANDLE hNotifyEvent, ThBgmFormat* pzwf);
    HRESULT CreateStreamingFromMemory(CStreamingSound** ppStreamingSound, u8* pbData, ULONG ulDataSize, ThBgmFormat* pzwf, DWORD dwCreationFlags, GUID guid3DAlgorithm, DWORD dwNotifyCount, DWORD dwNotifySize, HANDLE hNotifyEvent);
};
